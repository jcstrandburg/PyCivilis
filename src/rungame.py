...
class WidgetActivity( application.Activity):
    ...
    def on_create(self, config):
        ...
        self.container = interface.TestContainer( self.iface, (0,0,300,200))
        ...
        self.container2 = interface.TestContainer( self.iface, (400,100,300,200),
                            view_style=interface.VIEW_FIXED)
        
        self.testa = interface.TestWidget( self.iface, (50,50,100,30))
        self.testb = interface.TestWidget( self.iface, (50,100,100,30))
        self.testc = interface.TestWidget( self.iface, (50,150,100,30))
    ...
    def update(self):
        ...
        pos = (0,
                150+75*math.sin(self.ticker/40.0))
